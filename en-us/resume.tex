...
\begin{minipage}[t]{0.55\linewidth}
  ...
  $\;|\;$\href{https://pypi.org/user/ryan_shanghaitech/}{\textcolor{ieeeblue1}{\icon{../resource/pypi.png} PyPI}}$\;|\;$\href{https://github.com/RyanShanghaitech}{\textcolor{ieeeblue1}{\icon{../resource/github.png} GitHub}}
\end{minipage}
\vspace{1\baselineskip}
\\
\sanf{ieeeblue0}{\textbf{Summary:}} M.S. candidate at the School of Biomedical Engineering, ShanghaiTech University. Experienced in non-Cartesian pulse sequence design and reconstruction, with publications in IEEE TBME / ISMRM / SCMR / AAAI / JMRI, and open-source projects on PyPI / GitHub, invited as reviewer by IEEE TMI / ISMRM.
